#ifndef __QT_KEY_BINDING_H__
#define __QT_KEY_BINDING_H__
...
class KeyBinding : public BindingForm {
  Q_OBJECT

public:
  KeyBinding(QAccel *, iJGL *, MainWindow *, QWidget * =0, const char * =0);
  ~KeyBinding(void);
