...
#ifndef __Type_Interface_TypeTraits_h_
#define __Type_Interface_TypeTraits_h_

// $Header: /home/jason/cvs/Type/Interface/TypeTraits.h,v 1.1 2006/07/18 19:23:52 jason Exp $
...
////////////////////////////////////////////////////////////////////////////////
    ...
    namespace Private
    {
        ...
        typedef TYPELIST_3(float, double, long double) 
            StdFloats;
#else
        typedef nType::Seq<unsigned char, unsigned short int,unsigned int, unsigned long int>::Type
            StdUnsignedInts;
        typedef nType::Seq<signed char, short int,int, long int>::Type
            StdSignedInts;
        typedef nType::Seq<bool, char, wchar_t>::Type
            StdOtherInts;
        typedef nType::Seq<float, double, long double>::Type
            StdFloats;
...
#endif // __Type_Interface_TypeTraits_h__
