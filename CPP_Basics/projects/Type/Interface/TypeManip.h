...
// $Header: /home/jason/cvs/Type/Interface/TypeManip.h,v 1.1 2006/07/18 19:23:52 jason Exp $

#ifndef __Type_Interface_TypeManip_h__
#define __Type_Interface_TypeManip_h__
...
////////////////////////////////////////////////////////////////////////////////
    ...
    {
        enum { value = (::nType::Conversion<const volatile U*, const volatile T*>::exists &&
                      !::nType::Conversion<const volatile T*, const volatile void*>::sameType) };
    ...
    {
        enum { value = (::nType::Conversion<const volatile U*, const volatile void*>::exists &&
                      !::nType::Conversion<const volatile void*, const volatile void*>::sameType) };
    ...
    {
        enum { value = (::nType::Conversion<const volatile void*, const volatile T*>::exists &&
                      !::nType::Conversion<const volatile T*, const volatile void*>::sameType) };
...
////////////////////////////////////////////////////////////////////////////////
    ...
    struct SuperSubclassStrict
    {
        enum { value = (::nType::Conversion<const volatile U*, const volatile T*>::exists &&
                     !::nType::Conversion<const volatile T*, const volatile void*>::sameType &&
                     !::nType::Conversion<const volatile T*, const volatile U*>::sameType) };
    ...
    struct SuperSubclassStrict<void, U> 
    {
        enum { value = (::nType::Conversion<const volatile U*, const volatile void*>::exists &&
                     !::nType::Conversion<const volatile void*, const volatile void*>::sameType &&
                     !::nType::Conversion<const volatile void*, const volatile U*>::sameType) };
...
#define LOKI_SUPERSUBCLASS_STRICT(T, U) \
    ::nType::SuperSubclassStrict<T,U>::value
...
#endif // __Type_Interface_TypeManip_h__
