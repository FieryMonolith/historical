...
#ifndef __Functor_Inteface_ReturnlessMemFunWrap_h__
#define __Functor_Inteface_ReturnlessMemFunWrap_h__

/*!
 *
 * \class ReturnlessMemFunWrap
 *
 * \ingroup nFunctor
 *
 * ReturnlessMemFunWrap- This class is intended to wrap class member functions
 ...
 *   except it does not return anything.
 *
...
namespace nFunctor
{
  ...
  template <typename Obj, typename PointerToMemFn,
            typename R=void, typename T=nType::NullType>
  class ReturnlessMemFunWrap : public iFunctor<void, T> {
  public:
    ...
    ReturnlessMemFunWrap(OptObj o, PointerToMemFn pMemFn)
    : d_obj(o), d_pMemFun(pMemFn)
    {
      if(!d_obj()) { throw BadCallableEntity(); }
      return;
    }
    void SetFun(OptObj p, PointerToMemFn memFn) {
      d_obj = p;
      d_pMemFun = memFn;
      if(!d_obj()) { throw BadCallableEntity(); }
      return;
    ...
    ReturnlessMemFunWrap *Clone(void) const {
      return new ReturnlessMemFunWrap(*this);
    }

  private:
    Interface *DoClone(void) const { return new ReturnlessMemFunWrap(*this); }
  ...
  public:
    ...
    ResultType operator()(Parm1 p1, Parm2 p2, Parm3 p3, Parm4 p4,
                          Parm5 p5) const
    {
      (d_obj.p->*d_pMemFun)(p1, p2, p3, p4, p5);
      return;
    }
    ...
    ResultType operator()(Parm1 p1, Parm2 p2, Parm3 p3, Parm4 p4, Parm5 p5,
                          Parm6 p6) const
    {
      (d_obj.p->*d_pMemFun)(p1, p2, p3, p4, p5, p6);
      return;
    }
    ...
    {
      (d_obj.p->*d_pMemFun)(p1, p2, p3, p4, p5, p6, p7);
      return;
    }
    ...
    {
      (d_obj.p->*d_pMemFun)(p1, p2, p3, p4, p5, p6, p7, p8);
      return;
    }
    ...
    {
      (d_obj.p->*d_pMemFun)(p1, p2, p3, p4, p5, p6, p7, p8, p9);
      return;
    }
    ...
    ResultType operator()(Parm1 p1, Parm2 p2, Parm3 p3, Parm4 p4, Parm5 p5,
                          ...
                          Parm10 p10) const
    {
      (d_obj.p->*d_pMemFun)(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10);
      return;
    }
    ...
    ResultType operator()(Parm1 p1, Parm2 p2, Parm3 p3, Parm4 p4, Parm5 p5,
                          ...
                          Parm11 p11) const
    {
      (d_obj.p->*d_pMemFun)(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11);
      return;
    }
  ...
  const bool operator==(const ReturnlessMemFunWrap<T,U,V,W> &lhs,
                        const ReturnlessMemFunWrap<T,U,V,W> &rhs)
  {
