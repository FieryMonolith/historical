...
void CShapeFactory::Sphere(double p_radius, int partial, CGrTexture *tex)
{
...
void CShapeFactory::RingofSpheres(double s_radius, double r_radius, int partial, CGrTexture *tex)
{
...
void CShapeFactory::SphereFace(CGrPtr<CGrComposite> &p_sphere, int p_recurse, double p_radius, GLdouble *a, 
...
void CShapeFactory::RingofCylinders(double b_radius, double t_radius, double r_radius, double angle, int num, CGrTexture *tex1, CGrTexture *tex2)
{
...
void CShapeFactory::CreateCylinder(double brad, double trad, double height, bool ends,
...
void CShapeFactory::CreateHollowCylinder(double brad, double trad, 
